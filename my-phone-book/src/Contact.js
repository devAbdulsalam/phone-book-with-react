...
const Contact = () => {
    ...
    const mycontact = contact.filter((contact) => {
    if(contact.id === userId){
        return contact
    }

    return console.log("IntroPage")
    })
                    ...
                    <div key={id} >
                        <div className="bg-green-300 p-4">
                            <div>
                                ...
                                <div className="flex justify-end space-x-8 text-2xl text-white">
                                    ...
                                    <div onClick={() => {navigate("/home")}} className="relative mx-2">										
                        ...
                        <div className="bg-white p-2">
                            <article className="shadow-md flex justify-center items-center p-5">
                                <div onClick={() => {navigate("/calling")}} className="w-3/12 text-3xl text-green-500 cursor-pointer">
                                    <i className="fas fa-phone"></i>
                                </div>
                                <div className="flex justify-between items-center w-full border-b-teal-50 border-solid">
                                    <div onClick={() => {navigate("/calling")}}>
