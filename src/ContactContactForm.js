...
const CreateContactForm = () => {
    ...
    // const [alert, setAlert] = useState({show:true, msg: 'hello', type:"red"});
        // handleChange
    ...
    const handleSubmit = (e) => {
        ...
        const newContact = { ...contact, id: new Date().getTime().toString(), lastCall: 0, favourite: 0};
  ...
  return (
        <section id="createContactForm" className="bg-gray-400 z-20 h-screen pb-2 top-0 w-full">
            <div className="relative w-full">
                <div id="contactHead" className="bg-gray-600 p-2 fixed top-0 z-10  w-full">
                ...
                <div id="contactbody" className="w-full mt-[82px]">
